...
HSPTOKEN_DATA( HSPTOKEN_SAMPLETAP, "sampletap", HSPTOKENTYPE_OBJ, NULL)
HSPTOKEN_DATA( HSPTOKEN_SAMPLETAPDEV, "sampletapDev", HSPTOKENTYPE_ATTRIB,  "sampletap { dev=[path] }")
HSPTOKEN_DATA( HSPTOKEN_SAMPLETAPRATE, "sampletapRate", HSPTOKENTYPE_ATTRIB, "sampletap { rate=[n] }")
...
HSPTOKEN_DATA( HSPTOKEN_RATE, "rate", HSPTOKENTYPE_ATTRIB, NULL)
